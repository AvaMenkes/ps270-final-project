...
ggplot(overtime_data, aes(x = year, y = prop_nuclear, color = factor(regime_binary))) +
  geom_line() +
  scale_color_manual(
    values = c("0" = "indianred1", "1" = "steelblue1"),
