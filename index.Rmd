...
My explanatory variable is regime type. This variable is measured by Freedom House Data on political regimes, which organizes countries on a scale of 0-3 to range autocracies and liberal democracies. I've recorded this into a binary variable where countries with values of 2 or higher are liberal democracies and are coded as 1, and autocracies are coded with values of 1 or lower as 0. 
...
```{r print-code, re.label=knitr::all_labels(), echo = TRUE, eval=FALSE}
library(readr)
library(dplyr)
library(tidyverse)
```
...
#### Intercept, Coefficient, and P-Value
