...
```{r print-code-1, re.label=knitr::all_labels(), echo = F, eval= T}
library(readr)
library(dplyr)
library(tidyverse)
```

```{r print-code-2, re.label=knitr::all_labels(), echo = F, eval= T}
...
```{r print-code-3, re.label=knitr::all_labels(), echo = F, eval= T}
...
```{r print-code-4, re.label=knitr::all_labels(), echo = F, eval= T}
...
```{r print-code-5, re.label=knitr::all_labels(), echo = F, eval= T}
freedom_data <- freedom_data |>
  mutate(
...
```{r print-code-6, re.label=knitr::all_labels(), echo = F, eval= T}
...
```{r print-code-7, re.label=knitr::all_labels(), echo = F, eval= T}
...
```{r print-code-8, re.label=knitr::all_labels(), echo = F, eval= T}
...
```{r print-code-9, re.label=knitr::all_labels(), echo = F, eval= T}
...
ggplot(selected_countries, aes(x = year, y = nuclear_status, color = entity.x)) +
  geom_line(size = 1) +
  labs(
...
```{r print-code-10, re.label=knitr::all_labels(), echo = F, eval= T}
selected_countries <- combine_data |>
  filter(entity.x %in% c(
    "India", "Pakistan"
  ))
...
```{r print-code-11, re.label=knitr::all_labels(), echo = F, eval= T}
